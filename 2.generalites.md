...
***Cas concret :*** je tape google.com dans ma barre d'adresse de mon navigateur qui, en premier lieu, contacte le DNS pour trouver l'IP du serveur google.com `216.58.214.67`
